...
//        public async Task<Models.OperatingSystem> GetorAddOperatingSystemByNameAsync(OsFamily osFamilly, string name)
//        {
...
//        #region Servers
//        public Task<List<ServerGroup>> GetServersByGroupAsync(IEnumerable<int> groupIds)
//        {
...
//        public async Task<Server> AddServerAsync(string hostName, OsFamily osFamilly, string operatingSystemName, string environmentName, System.Net.IPAddress subnetIP)
//        {
