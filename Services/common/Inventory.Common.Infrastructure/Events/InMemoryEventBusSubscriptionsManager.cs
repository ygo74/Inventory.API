...
namespace Inventory.Common.Infrastructure.Events
{
    public partial class InMemoryEventBusSubscriptionsManager : IEventBusSubscriptionsManager
    {
        ...
        private readonly new Dictionary<string, Type> _eventTypes;
        ...
        private SubscriptionInfo FindSubscriptionToRemove<T, TH>(string eventName=null)
             where T : IntegrationEvent
             where TH : IIntegrationEventHandler<T>
        {
            if (string.IsNullOrWhiteSpace(eventName))
        ...
        {
            if (!_eventTypes.ContainsKey(eventName)) return null;
